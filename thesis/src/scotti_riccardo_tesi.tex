...
\usepackage{braket} % bra-ket notation for quantum mechanics
...
\include{chapters/04proposed_method}
\include{chapters/05experimental_setup}
\include{chapters/06results}
